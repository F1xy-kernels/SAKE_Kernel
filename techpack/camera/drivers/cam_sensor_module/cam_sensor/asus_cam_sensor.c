...
#define REMOSAIC_CALI_START_SAKE_IMX686 0X821
#define REMOSAIC_CALI_END_SAKE_IMX686 0X13F2
...
#define VODKA_REMOSAIC_CALI_START 0x1023
#define VODKA_REMOSAIC_CALI_END 0x1BF4
#define VODKA_REMOSAIC_CALI_SIZE (REMOSAIC_CALI_END-REMOSAIC_CALI_START+1)
#endif
...
static eeprom_group_t  g_eeprom_group[] =
{
  ...
  //MODULE_ID  SENSOR_NAME  AF_INFINITY_START_ADDR  AF_MACRO_START_ADDR
  {0x6C,       "IMX363_P",  CALI_AF_INFINITY_START, CALI_AF_MACRO_START,
               //PDAF_CALI_START_ADDR    REMOSAIC_CALI_START_ADDR     LRC_START
                 PDAF_CALI_START, -1,         -1,
               //LRC_SIZE  DUAL_NUM  IS_CHANGED  IsSuporrtVersion
                 0,        2,        0,          0},
  ...
  {0x71,        "IMX686_V",  CALI_AF_INFINITY_START, CALI_AF_MACRO_START,
               //PDAF_CALI_START_ADDR    REMOSAIC_CALI_START_ADDR     LRC_START
               PDAF_CALI_IMX686_START,  VODKA_REMOSAIC_CALI_START, LRC_START,
               //LRC_SIZE  DUAL_NUM  IS_CHANGED  IsSuporrtVersion
               LRC_SIZE, 0,       0,0},
  //MODULE_ID  SENSOR_NAME  AF_INFINITY_START_ADDR  AF_MACRO_START_ADDR
  {0x70,        "OV08A10_V", CALI_AF_INFINITY_START, CALI_AF_MACRO_START,
               //PDAF_CALI_START_ADDR    REMOSAIC_CALI_START_ADDR     LRC_START
               PDAF_CALI_START,        -1,                          -1,
               //LRC_SIZE  DUAL_NUM  IS_CHANGED  IsSuporrtVersion
               0,       0,       0,0},
  ...
  //MODULE_ID  SENSOR_NAME	AF_INFINITY_START_ADDR	AF_MACRO_START_ADDR
  {0x6D,	    "IMX363_V",	 CALI_AF_INFINITY_START, CALI_AF_MACRO_START,
						 //PDAF_CALI_START_ADDR 	 REMOSAIC_CALI_START_ADDR 		LRC_START
							 PDAF_CALI_START, -1, 				-1,
						 //LRC_SIZE  DUAL_NUM  IS_CHANGED  IsSuporrtVersion
							 0,      1,				0,					0},
...
//MODULE_ID  SENSOR_NAME  AF_INFINITY_START_ADDR  AF_MACRO_START_ADDR
  {0x76,       "IMX686_S",  CALI_AF_INFINITY_START, CALI_AF_MACRO_START,
		//PDAF_CALI_START_ADDR    REMOSAIC_CALI_START_ADDR     LRC_START
		  PDAF_CALI_IMX686_START, REMOSAIC_CALI_START_SAKE_IMX686,         LRC_START,
		//LRC_SIZE  DUAL_NUM  IS_CHANGED  IsSuporrtVersion
		  LRC_SIZE, 0,        0,          0},

//MODULE_ID  SENSOR_NAME  AF_INFINITY_START_ADDR  AF_MACRO_START_ADDR
  {0x77,       "IMX663_S",  CALI_AF_INFINITY_START,  CALI_AF_MACRO_START,
               //PDAF_CALI_START_ADDR    REMOSAIC_CALI_START_ADDR     LRC_START
                 PDAF_CALI_START,              -1,                                                -1,
               //LRC_SIZE  DUAL_NUM  IS_CHANGED  IsSuporrtVersion
                 0,        0,                        0,            0},
//MODULE_ID  SENSOR_NAME	AF_INFINITY_START_ADDR	AF_MACRO_START_ADDR
  {0x75,       "IMX363_S",	CALI_AF_INFINITY_START, CALI_AF_MACRO_START,
						 //PDAF_CALI_START_ADDR 	 REMOSAIC_CALI_START_ADDR 		LRC_START
							 PDAF_CALI_START, -1, 				-1,
						 //LRC_SIZE  DUAL_NUM  IS_CHANGED  IsSuporrtVersion
							 0,      1,		   0,					0},
...
void asus_cam_sensor_init(struct cam_sensor_ctrl_t *s_ctrl)
{
	...
	if(!g_sensor_init_state[s_ctrl->id])
	{
		...
		ois_probe_check(s_ctrl->sensordata->slave_info.sensor_id);
		//ASUS_BSP Lucien ---: check ois at probe
